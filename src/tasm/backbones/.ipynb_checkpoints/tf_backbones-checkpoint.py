...
# Backbone
################################################################################
def create_base_model(name="EfficientNetV2S", weights="imagenet", height=None, width=None,
    ...
    if name.lower() == "densenet121":
        ...
        layer_names = ["block2a_expand_activation", "block3a_expand_activation", "block4a_expand_activation", "block6a_expand_activation", "top_activation"]
    elif name.lower() == "efficientnetv2b0":
            if height <= 31 or width <= 31:
                raise ValueError("Parameters 'height' and 'width' should not be smaller than 32.")
            base_model = tf.keras.applications.efficientnet_v2.EfficientNetV2B0(include_top=include_top, weights=weights, input_shape=input_shape, pooling=pooling)
            layer_names = ["block1a_project_activation", "block2b_expand_activation", "block4a_expand_activation", "block6a_expand_activation", "block6h_project_conv"]
            
            
    elif name.lower() == "efficientnetv2b3":
            if height <= 31 or width <= 31:
                raise ValueError("Parameters 'height' and 'width' should not be smaller than 32.")
            base_model = tf.keras.applications.efficientnet_v2.EfficientNetV2B3(include_top=include_top, weights=weights, input_shape=input_shape, pooling=pooling)
            layer_names = ["block1a_project_activation", "block2c_expand_activation", "block4a_expand_activation", "block6a_expand_activation", "block6l_project_conv"]
            
    elif name.lower() == "efficientnetn2s":
            if height <= 31 or width <= 31:
                raise ValueError("Parameters 'height' and 'width' should not be smaller than 32.")
            base_model = tf.keras.applications.efficientnet_v2.EfficientNetV2S(include_top=include_top, weights=weights, input_shape=input_shape, pooling=pooling)
            layer_names = ["block1b_project_activation", "block2d_expand_activation", "block4a_expand_activation", "block6a_expand_activation", "block6o_activation"]
            
    elif name.lower() == "efficientnetn2m":
            if height <= 31 or width <= 31:
                raise ValueError("Parameters 'height' and 'width' should not be smaller than 32.")
            base_model = tf.keras.applications.efficientnet_v2.EfficientNetV2M(include_top=include_top, weights=weights, input_shape=input_shape, pooling=pooling)
            layer_names = ["block1b_project_activation", "block2e_expand_activation", "block4a_expand_activation", "block6a_expand_activation", "block7e_activation"]
